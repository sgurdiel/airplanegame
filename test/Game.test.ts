...
describe('Game', () => {
  ...
  test('Correcting screen size unpauses', () => {
    let supportedScreenSizeMock = jest
      .spyOn(DomUi.prototype, 'supportedScreenSize')
      .mockReturnValue(false);
    jest
      .spyOn(DomUi.prototype, 'getGameContainer')
      .mockImplementation(() => document.createElement('div'));
    const windowResizeEventMock = jest
      .spyOn(DomUi.prototype, 'windowResizeEvent')
  ...
  test('No screen size validation when game has ended', () => {
    ...
    const supportedScreenSizeMock = jest
      .spyOn(DomUi.prototype, 'supportedScreenSize')
      .mockReturnValue(true);
    jest
      .spyOn(DomUi.prototype, 'getGameContainer')
    ...
    jest.spyOn(DomUi.prototype, 'repaint').mockImplementation((g) => {
      if (false === framePainted) {
        framePainted = true;
        g.paintFrame(0);
      }
    });
  ...
  test('Mouse move', () => {
    ...
    jest
      .spyOn(DomUi.prototype, 'moveAirplaneEvent')
      .mockImplementation((listener) => {
  ...
  test('Mouse click', () => {
    jest
      .spyOn(DomUi.prototype, 'fireAirplaneFireRoundEvent')
      .mockImplementation((listener) => {
